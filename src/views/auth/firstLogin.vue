    ...
    >
      ...
      <label
        ><input
          ...
          v-verify:[adNumValidArg]="firstLoginChecking.adNum"
          v-model="adNum"
        />
      </label>
      ...
      <label
        ><input
          type="password"
          class="inp w-full border-2 border-primaryDark h-10"
          v-verify:[mimaValidArg]="firstLoginChecking.mima"
          v-model="mima"
      /></label>
      ...
      <label
        ><input
          type="email"
          class="inp w-full border-2 border-primaryDark h-10"
          v-verify:[firstEmailValidArg]="firstLoginChecking.firstEmail"
          v-model="firstEmail"
      /></label>
...
const adNumValidArg = ["notNull"];
const mimaValidArg = [, "notNull", "charMin(6)", "charMax(12)", "numMixEn"];
const firstEmailValidArg = ["notNull"];
const firstLoginChecking = ref({
  adNum: { pass: null, msg: null },
  mima: { pass: null, msg: null },
  firstEmail: { pass: null, msg: null },
});
//
...
const firstLoginOtp = async () => {
  for (let item in firstLoginChecking.value) {
    if (firstLoginChecking.value[item].pass != true) {
