<template>
  <div class="w-full md:w-1/3 lg:w-1/4 p-2">
    ...
    <div class="bg-primaryLight w-full rounded-b p-2">
      <p class="text-sm md:text-base whitespace-nowrap overflow-x-scroll scrollbar">
        {{ sysMsg.sysMsg.memo }}
      </p>
    </div>
  </div>
  ...
  >
    <div
      class="absolute rounded-md border bg-background shadow-lg inset-y-16 md:inset-y-24 w-[90%] md:w-[50%] lg:w-[35%] rounded z-50 overflow-y-auto scrollbar"
    >
